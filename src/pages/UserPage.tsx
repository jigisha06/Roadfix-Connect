...
import { MapPin, Upload, X, LogOut, Clock, FileText, Award, Globe, WifiOff, CheckCircle, AlertTriangle, Users, User, ChevronDown } from 'lucide-react';
...
const blueIcon = new L.Icon({
  iconUrl: 'data:image/svg+xml;base64,',
  iconSize: [32, 32],
  iconAnchor: [16, 16],
  popupAnchor: [0, -16],
});

const locationArrowIcon = new L.Icon({
  iconUrl: 'data:image/svg+xml;base64,',
  iconSize: [48, 48],
  iconAnchor: [24, 24],
  popupAnchor: [0, -24],
});
...
const translations = {
  English: {
    ...
    enterAddress: 'Enter full address (e.g., Street, Area, City, State)',
    latitude: 'Latitude',
    longitude: 'Longitude',
    landmark: 'Nearby Landmark',
    enterLandmark: 'Enter nearby landmark (e.g., Near Metro Station)',
    detectLocation: 'Detect Location on Map',
    detectingAddress: 'Detecting address...',
    locationDetectedPinned: 'Location detected and pinned on map',
    addressNotFound: 'Address not found. Please enter a more precise address.',
  ...
  Hindi: {
    ...
    city: 'शहर',
    address: 'पूरा पता',
    enterAddress: 'पूरा पता दर्ज करें (जैसे, सड़क, क्षेत्र, शहर, राज्य)',
    latitude: 'अक्षांश',
    longitude: 'देशांतर',
    landmark: 'नजदीकी लैंडमार्क',
    enterLandmark: 'नजदीकी लैंडमार्क दर्ज करें (जैसे, मेट्रो स्टेशन के पास)',
    detectLocation: 'मानचित्र पर स्थान का पता लगाएं',
    detectingAddress: 'पता पता लगाया जा रहा है...',
    locationDetectedPinned: 'स्थान का पता लगाया गया और मानचित्र पर पिन किया गया',
    addressNotFound: 'पता नहीं मिला। कृपया अधिक सटीक पता दर्ज करें।',
  ...
  Tamil: {
    ...
    city: 'நகரம்',
    address: 'முழு முகவரி',
    enterAddress: 'முழு முகவரியை உள்ளிடவும் (எ.கா., தெரு, பகுதி, நகரம், மாநிலம்)',
    latitude: 'அட்சரேகை',
    longitude: 'தீர்க்கரேகை',
    landmark: 'அருகிலுள்ள அடையாளம்',
    enterLandmark: 'அருகிலுள்ள அடையாளத்தை உள்ளிடவும் (எ.கா., மெட்ரோ நிலையத்திற்கு அருகில்)',
    detectLocation: 'வரைபடத்தில் இடத்தைக் கண்டறியவும்',
    detectingAddress: 'முகவரி கண்டறியப்படுகிறது...',
    locationDetectedPinned: 'இடம் கண்டறியப்பட்டு வரைபடத்தில் பின் செய்யப்பட்டது',
    addressNotFound: 'முகவரி கிடைக்கவில்லை. மேலும் துல்லியமான முகவரியை உள்ளிடவும்.',
    reportedLocation: 'அறிவிக்கப்பட்ட இடம்',
  ...
  Telugu: {
    ...
    enterAddress: 'పూర్తి చిరునామా నమోదు చేయండి (ఉదా., వీధి, ప్రాంతం, నగరం, రాష్ట్రం)',
    latitude: 'అక్షాంశం',
    longitude: 'రేఖాంశం',
    landmark: 'సమీపంలోని ల్యాండ్‌మార్క్',
    enterLandmark: 'సమీపంలోని ల్యాండ్‌మార్క్‌ను నమోదు చేయండి (ఉదా., మెట్రో స్టేషన్ దగ్గర)',
    detectLocation: 'మ్యాప్‌లో స్థానాన్ని గుర్తించండి',
    detectingAddress: 'చిరునామా గుర్తించబడుతోంది...',
    locationDetectedPinned: 'స్థానం గుర్తించబడింది మరియు మ్యాప్‌లో పిన్ చేయబడింది',
    addressNotFound: 'చిరునామా కనుగొనబడలేదు. దయచేసి మరింత ఖచ్చితమైన చిరునామాను నమోదు చేయండి.',
    reportedLocation: 'నివేదించిన స్థానం',
...
export default function UserPage() {
  ...
  const [submittedLocation, setSubmittedLocation] = useState<{position: [number, number]; city: string; address: string} | null>(null);
  ...
  const geocodeAddress = async () => {
    ...
    try {
      const response = await fetch(
        ...
        {
          headers: {
            'User-Agent': 'RoadFix Connect App'
          }
        }
      );
      ...
      if (data && data.length > 0) {
        ...
        const detectedCity = result.address?.city ||
                           result.address?.town ||
        ...
        setGeocodingError(t.addressNotFound);
        setLocationDetected(false);
        setPosition(null);
        setCity('');
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!issueType || !description || !image || !position || !city || !address) {
      alert('Please wait for location detection or enable location services');
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 bg-white hover:bg-gray-50 rounded-lg transition-colors border border-gray-200"
                >
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-[2100]">
                    <button
                      onClick={() => {
                        navigate('/citizen/community-reports');
                        setDropdownOpen(false);
                      }}
                      className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50 transition-colors text-left"
                    >
                      <Users size={18} className="text-gray-600" />
                      <span className="text-sm font-medium text-gray-700">{t.communityReports}</span>
                    </button>
                    ...
                    {userStats && (
                      <div className="px-4 py-2.5 bg-gradient-to-r from-blue-50 to-purple-50 border-t border-gray-100">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-sm font-semibold text-gray-900">{userStats.points} {t.points}</div>
                            {userStats.verified_reports_count >= 5 && (
                              <div className="text-xs text-blue-600 mt-0.5">{t.contributor}</div>
                            )}
                          </div>
                        </div>
                      </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {showForm && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-[2000] overflow-y-auto">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md lg:max-w-6xl my-8">
              ...
              {success ? (
                      ...
                      <div className="bg-white border-2 border-green-200 rounded-lg overflow-hidden shadow-sm">
                        <div className="bg-green-50 px-3 py-2 border-b border-green-200">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium text-green-900">{t.reportedLocation}</span>
                          </div>
                        </div>
                        <div className="h-48 relative">
                          <MapContainer
                            center={submittedLocation.position}
                            zoom={16}
                          ...
                          >
                            <TileLayer
                              ...
                              url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
                            />
                            <Marker position={submittedLocation.position} icon={locationArrowIcon} />
                          </MapContainer>
                        </div>
                        <div className="bg-gray-50 px-3 py-2 border-t border-gray-200">
                          <p className="text-xs text-gray-600 mb-1">{submittedLocation.address}</p>
                          <p className="text-xs font-medium text-gray-900">{submittedLocation.city}</p>
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div className="lg:grid lg:grid-cols-3 lg:gap-6">
                  <div className={`lg:col-span-2 ${locationDetected && position ? 'lg:border-r lg:border-gray-200' : ''}`}>
                    <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[calc(100vh-200px)] lg:max-h-[600px] overflow-y-auto">
                  <div>
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    ...
                    <button
                      ...
                      className="w-full mt-3 bg-blue-600 hover:bg-blue-700 text-white py-2.5 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
                      {detectingLocation ? (
                        <>
                    ...
                    {geocodingError && (
                      <div className="flex items-center gap-2 px-3 py-2 bg-red-50 border border-red-200 rounded-lg mt-3">
                        <AlertTriangle size={16} className="text-red-600 flex-shrink-0" />
                        <span className="text-sm text-red-700">{geocodingError}</span>
                      </div>
                    )}
                    ...
                    {locationDetected && position && (
                      <div className="mt-3 space-y-3 animate-fadeIn">
                        <div className="flex items-center gap-2 px-3 py-2 bg-green-50 border border-green-200 rounded-lg">
                          ...
                          <span className="text-sm text-green-700">{t.locationDetectedPinned}</span>
                        </div>

                        <div className="lg:hidden bg-white border-2 border-blue-200 rounded-lg overflow-hidden shadow-sm">
                          <div className="bg-blue-50 px-3 py-2 border-b border-blue-200">
                            <div className="flex items-center gap-2">
                              <MapPin size={16} className="text-blue-600" />
                              <span className="text-sm font-medium text-blue-900">{t.reportedLocation}</span>
                            </div>
                          </div>
                          <div className="h-48 relative">
                            <MapContainer
                            ...
                            >
                              <TileLayer
                                ...
                                url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
                              />
                              <Marker position={position} icon={locationArrowIcon} />
                            </MapContainer>
                          </div>
                        </div>
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 space-y-2">
                          <div>
                            ...
                            <input
                              ...
                              value={city}
                              readOnly
                              className="w-full px-2 py-1.5 bg-white border border-gray-200 rounded text-sm text-gray-700 cursor-not-allowed"
                            />
                          </div>
                          <div className="grid grid-cols-2 gap-2">
                            <div>
                              <label className="block text-xs font-medium text-gray-600 mb-1">{t.latitude}</label>
                              <input
                                type="text"
                            ...
                            <div>
                              <label className="block text-xs font-medium text-gray-600 mb-1">{t.longitude}</label>
                              <input
                                type="text"
                ...
                {locationDetected && position && (
                  <div className="hidden lg:block lg:col-span-1 bg-gray-50 p-6">
